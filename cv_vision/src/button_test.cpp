...
void second_Localization(cv::Mat src_img)
{
    ...
    sprintf(translation_x, "robot_x = %.3f ", arm_x);
    sprintf(translation_y, "robot_y = %.3f ", arm_y);
    sprintf(translation_z, "robot_z = %.3f ", arm_z);

    sprintf(rotation_x, "robot_rx = %.3f ", arm_rx);
    sprintf(rotation_y, "Robot_ry = %.3f ", arm_ry);
    sprintf(rotation_z, "Robot_rz = %.3f ", arm_rz);
